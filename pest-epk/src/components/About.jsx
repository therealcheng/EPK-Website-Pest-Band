...
const About = () => {
  return (
    <div className=' about'>
      <h2 className='text-2xl text-black font-bold md:text-4xl uppercase p-12'>
        PEST are a punk rock two piece based in Hertfordshire.
      </h2>
      <p className='mt-6 text-black px-10 text-lg pt-4'>
        ...
        Nu-Metal riffs and Punk Rock vocal by Cameron Taylor.
      </p>
      <p className='mt-4 text-black px-10 text-lg pt-6'>
